...
test_that("'check_prob' returns TRUE with valid inputs", {
  expect_true(check_prob(c(0.5, 0.5, 0.5), all_equal = TRUE, nm = "prob_target"))
  expect_true(check_prob(0, nm = "prob_target"))
})
